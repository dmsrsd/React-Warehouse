...
function TableMonitoringShipmentPlan({ tableRef }) {
  ...
  const data = [
    {
      ...
      dc_tujuan: "DC A",
      remarks: "Remarks for PO 12345 Rokok A",
      status: "Pick Up",
    },
    {
      id: 2,
      ...
      dc_tujuan: "DC B",
      remarks: "Remarks for PO 12345 Rokok B",
      status: "Request",
    },
    {
      id: 3,
      ...
      dc_tujuan: "DC C",
      remarks: "Remarks for PO 12345 Rokok C",
      status: "Request",
    },
    {
      id: 4,
      ...
      dc_tujuan: "DC D",
      remarks: "Remarks for PO 12345 Rokok D",
      status: "On The Way",
    },
    {
      id: 5,
      ...
      dc_tujuan: "DC E",
      remarks: "Remarks for PO 12345 Rokok E",
      status: "Request",
    },
  ];
...
export default TableMonitoringShipmentPlan;

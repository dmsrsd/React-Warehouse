...
function TableExtPickUpRequest({ tableRef }) {
  ...
  useLayoutEffect(() => {
    ...
    table.current = $("#table-react").DataTable({
      ...
      columns: [
        ...
        { data: "checkDetail", title: "Check Detail" },
      ],
      columnDefs: [
        {
          targets: ["checkDetail"],
    ...
    <>
      ...
      <Modal show={showModalAction} scrollable size="xl">
        <Modal.Header>
          ...
          <Modal.Title>External</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            ...
            <Form.Group controlId="deliveryDate" className="mt-3">
              <Form.Label>No Telp. Driver</Form.Label>
              <Form.Control />
            </Form.Group>
            ...
            <Form.Group controlId="deliveryDate" className="mt-3">
              <Form.Label>No Telp. Vendor</Form.Label>
              <Form.Control />
            </Form.Group>
...
export default TableExtPickUpRequest;
